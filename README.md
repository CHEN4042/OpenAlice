...
![AgentScope Java](https://img.shields.io/badge/AgentScope%20Java-2.0.0-9cf)
...
- 🧪 后端底座**预选** [AgentScope Java 2.0](docs/decisions/01-agentscope-vs-springai.md)（未实测，可能回退）。
